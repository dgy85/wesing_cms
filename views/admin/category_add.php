                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input readonly type="text" id="meta_image" name="meta_image" placeholder="分类大图" class="col-xs-10 col-sm-5">
                        ...
                        <div class="form-group switch-content hidden">
                            ...
                            <div class="col-sm-9">
                                <textarea id="description" name="description" placeholder="内容概要" class="col-xs-10 col-sm-5"></textarea>
                                <span class="help-inline col-xs-12 col-sm-7 text-danger">
                                    <span class="middle"></span>
                                </span>
                            </div>
